...
class ModBuilder
{
    ...
    private void BuildExtern(ExternDecl externDecl)
    {
    ...
    private void BuildFunc(FuncDefNode funcDef)
    {
    ...
    public LLVMModuleRef Build(TopLevelStatement[] statements)
    {
        foreach(var statement in statements)
        {
            switch (statement)
            {
                case ExternDecl externDecl:
